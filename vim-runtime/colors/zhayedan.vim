...
hi Normal       guifg=#607371   guibg=#071f29   ctermfg=007    ctermbg=000       gui=none      cterm=none
...
hi MatchParen   guifg=bg        guibg=#c0e070   ctermbg=bg     ctermbg=192       gui=none      cterm=bold
...
" == Text Selection ==
hi Cursor       guifg=bg        guibg=fg        ctermbg=bg     ctermbg=fg        gui=none      cterm=none
hi CursorIM     guifg=bg        guibg=fg        ctermbg=bg     ctermbg=fg        gui=none      cterm=none
...
hi IncSearch    guifg=bg        guibg=#50d0d0   ctermbg=bg     ctermbg=029       gui=none      cterm=none
hi Search       guifg=bg        guibg=#e0a020   ctermbg=bg     ctermbg=025       gui=none      cterm=none

" == UI ==
hi Pmenu        guifg=#000000   guibg=#b0b0b0   ctermbg=bg     ctermbg=252       gui=none      cterm=none
hi PmenuSel     guifg=#e0e0e0   guibg=#205070   ctermfg=fg     ctermbg=024       gui=none      cterm=none
hi PMenuSbar    guifg=bg        guibg=#b0b0b0   ctermbg=bg     ctermbg=254       gui=none      cterm=none
hi PMenuThumb   guifg=NONE      guibg=#808080   ctermfg=fg     ctermbg=244       gui=none      cterm=none
hi StatusLine   guifg=bg        guibg=#b0b0b0   ctermfg=253    ctermbg=238       gui=bold      cterm=bold
hi StatusLineNC guifg=#404040   guibg=#b0b0b0   ctermfg=240    ctermbg=252       gui=none      cterm=none
hi TabLine      guifg=bg        guibg=#b0b0b0   ctermbg=bg     ctermbg=252       gui=none      cterm=none
...
hi Folded       guifg=bg        guibg=#808080   ctermbg=bg     ctermbg=246       gui=none      cterm=none
hi FoldColumn   guifg=bg        guibg=#808080   ctermbg=bg     ctermbg=246       gui=none      cterm=none
...
hi LineNr       guifg=bg        guibg=#808080   ctermbg=bg     ctermbg=246       gui=none      cterm=none
