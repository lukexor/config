...
alias glf='git log -p'
alias glg='git log --graph --pretty=format:"%C(yellow)%h %ad%Cred%d %Creset%Cblue[%cn]%Creset  %s (%ar)" --date=iso'
alias glg5='glg --max-count=5'
alias glp='git log -p'
alias gls='git --no-pager log --pretty=format:"%C(yellow)%h %ad%Cred%d %Creset%Cblue[%cn]%Creset  %s (%ar)" --date=iso -100'
alias glt='git describe --tags --abbrev=0'
alias gll='git --no-pager log --pretty=format:"%C(yellow)%h %ad%Cred%d %Creset%Cblue[%cn]%Creset  %s (%ar)" --numstat --date=iso -100'
...
alias gtoday='git --no-pager log --graph --pretty=format:"%C(yellow)%h %ad%Cred%d %Creset%Cblue[%cn]%Creset  %s (%ar)" --date=iso --all --branches=* --remotes=* --since="yesterday.4pm" --author="$(git config user.name)"'
