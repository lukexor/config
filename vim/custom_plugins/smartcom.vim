...
inoremap <silent> <TAB><TAB> <c-r>=<SID>Complete()<CR>
...
" Remap <C-J> to have special behaviour when placeholders are pending
inoremap <silent> <C-J> <c-r>=<SID>PlaceHolder()<CR>
...
" Give PlaceHolder key special behaviour when placeholders are pending...

function! <SID>PlaceHolder ()
