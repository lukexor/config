...
# Misc
export PAGER="vim -M +MANPAGER -i NONE -c 'setlocal nofoldenable nolist' -"
export EDITOR="nvim"
export LANG="en_US.UTF-8"
export FZF_DEFAULT_COMMAND='(rg --files --hidden --no-ignore --ignore-file ~/.ignore || ag --hidden -p ~/.ignore -g "") 2> /dev/null'
